...
SECRET_KEY = os.getenv('DJANGO_SECRET_KEY',
                       '!94cvjzfvjm9u%q&6dfsgx0_t$^vd_7(%v(h008)kiayb8b2%*')
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DATABASE_NAME', 'hr'),
        'USER': os.environ.get('DATABASE_USER', 'hr'),
        'PASSWORD': os.environ.get('DATABASE_PWD', 'hr'),
...
EMAIL_FROM_ADDRESS = os.getenv(
    'DJANGO_EMAIL_FROM_ADDRESS', 'support@project.apps.avantrio.xyz')
